    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="地区" align="center" key="area" prop="area" v-if="columns[6].visible"/>
            <el-table-column label="职业" align="center" key="career" prop="career" v-if="columns[7].visible"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="地区" prop="area">
              <el-input v-model="form.area" placeholder="请输入地区" maxlength="20"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="职业" prop="career">
              <el-input v-model="form.career" placeholder="请输入职业" maxlength="20"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
