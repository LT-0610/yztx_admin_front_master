<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="视频收藏量" prop="videoCollect">
        <el-input
          v-model="queryParams.videoCollect"
          placeholder="请输入视频收藏量"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="videoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="视频类型" align="center" prop="videoType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_video_type" :value="scope.row.videoType"/>
        </template>
      </el-table-column>
      <el-table-column label="视频名称" align="center" prop="videoName" />
      <el-table-column label="视频内容" align="center" prop="videoUrl" />
      <el-table-column label="视频收藏量" align="center" prop="videoCollect" />
      <el-table-column label="视频简介" align="center" prop="videoIntroduction" />
      <el-table-column label="视频封面" align="center" prop="videoCover" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.videoCover" :width="50" :height="50"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="视频内容">
          <editor v-model="form.videoUrl" :min-height="192"/>
        </el-form-item>
        <el-form-item label="视频收藏量" prop="videoCollect">
          <el-input v-model="form.videoCollect" placeholder="请输入视频收藏量" />
        </el-form-item>
        <el-form-item label="视频简介" prop="video introduction">
          <el-input v-model="form.videoIntroduction" placeholder="请输入视频简介" />
        </el-form-item>
        <el-form-item label="视频封面" prop="videoCover">
          <image-upload v-model="form.videoCover"/>
        </el-form-item>
      </el-form>
